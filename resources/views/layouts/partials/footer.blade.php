    ...
    <div class="row">
      <div class="col-xl-4 col-lg-3 col-sm-6 column"><span>boolbnb</span></div>
        ...
        <div class="col-xl-2 col-lg-3 col-sm-3 column">
          <div class="row">
            <a href="{{route('guest.search')}}">Search</a>
          </div>
          {{-- <div class="row">
            <a href="">Projects</a>
          </div> --}}
        ...
        <div class="col-xl-2 col-lg-3 d-sm-none d-md-none d-lg-block column">
          <div class="row">
            <a href="#">About</a>
          </div>
          {{-- <div class="row">
        ...
        <div class="col-lg-9 d-none d-lg-block d-xl-none column">
        </div>


        <div class="col-xl-2 col-lg-3 col-sm-9 column">
          <div class="row">
            <a href="{{route('register')}}" class="joinCommunity">JOIN OUR COMMUNITY &#128293</a>
          </div>
          {{-- <div class="row email d-flex align-items-center">
        ...
        <div class="col-sm-3 d-none d-sm-block d-md-block d-lg-none column">
          <div class="row">
